%XMLTestRunDisplay
% Logs MATLAB x-unit tests in JUnit-style XML. The XML output can be used
% with Hudson to continuously monitor code quality.
%
...
classdef XMLTestRunDisplay < CommandWindowTestRunDisplay
    ...
    methods (Access = protected)
        ...
        function testRunFinished(this, totalRunTime)
            import wholecell.util.escapeXML;
            
            this.displayFaults();
            
            [~, hostName] = wholecell.util.computerInfo();          
