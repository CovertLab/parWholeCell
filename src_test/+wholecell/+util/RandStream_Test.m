...
classdef RandStream_Test < TestCase
    ...
    methods
        function this = RandStream_Test(name)
            ...
            this.randStream = wholecell.util.RandStream('mcg16807', 'seed', 1);
        end
    end
    ...
    methods
        ...
        function testGetters(this)
            ...
            assertEqual('Polar', this.randStream.normalTransform);
        ...
        function testEquality(~)
            r1 = wholecell.util.RandStream('mcg16807', 'seed', 1);
            r2 = wholecell.util.RandStream('mcg16807', 'seed', 1);
        ...
        function testReproducibility(this)
            ...
            defaultStreamNormalTransform = defaultStream.NormalTransform;
            ...
            assertEqual(defaultStreamNormalTransform, defaultStream.NormalTransform);
    ...
    methods
        function [stream, val] = helper_testReproducibility(~, seed)
            stream = wholecell.util.RandStream('mcg16807', 'seed', seed);
