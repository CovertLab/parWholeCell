...
classdef RandStream < handle
    ...
    methods
        ...
        function set.seed(this, value)
            rs = this.randStream;
            this.randStream = RandStream(rs.Type, 'Seed', value, 'NormalTransform', rs.NormalTransform);
        end
        ...
        function value = get.normalTransform(this)
            value = this.randStream.NormalTransform;
        end
        
        function set.normalTransform(this, value)
            this.randStream.NormalTransform = value;
        end
